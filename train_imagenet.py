...
parser.add_argument('--arch', '-a', default='i2vvgg',
    ...
    while True:
        ...
        if train:
            ...
            if train_count % 1000 == 0:
                ...
                .format(train_count, train_count * args.batchsize,datetime.timedelta(seconds=duration), throughput))
            ...
            if val_count == 15000:
                mean_loss = val_loss * args.val_batchsize / 15000
                mean_error = 1 - val_accuracy * args.val_batchsize / 15000
                print(file=sys.stderr)
